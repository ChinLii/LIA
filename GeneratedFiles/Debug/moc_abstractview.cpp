...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AbstractView_t, stringdata) + ofs \
...
const QMetaObject AbstractView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AbstractView.data,
...
void *AbstractView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AbstractView.stringdata))
